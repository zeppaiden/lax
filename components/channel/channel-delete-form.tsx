...
export function ChannelDeleteForm({ channel, children }: { channel: Channel, children?: React.ReactNode }) {
  ...
  const handleDelete = async () => {
    if (!current_network?.network_id) {
      toast.error("No network selected", {
        description: "Please select a network before deleting a channel",
      })
      return
    }
    ...
    toast.success("Channel deleted successfully", {
      description: "You should no longer see this channel in your list",
    })
  }
    ...
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Are you sure you want to delete the channel &quot;{current_channel?.name}&quot;? 
